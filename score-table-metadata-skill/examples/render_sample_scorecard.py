    ...
    return {
        ...
        "columns": [
            {"name": "encounter_id", "type": "STRING", "mode": "NULLABLE",
             "description": "Stable encounter identifier used to join to clinical detail tables."},
            {"name": "patient_account_num", "type": "STRING", "mode": "NULLABLE",
             "description": "Account number assigned at registration; combine with coid for uniqueness."},
            {"name": "discharge_disposition_code", "type": "STRING", "mode": "NULLABLE",
             "description": "Coded discharge status from ADT; values map to home, transfer, expired, hospice. Nullable for in-progress encounters."},
            {"name": "encounter_start_timestamp", "type": "TIMESTAMP", "mode": "NULLABLE",
             "description": "Encounter start time in UTC, ISO 8601."},
            {"name": "latest_record_ind", "type": "INT64", "mode": "NULLABLE",
             "description": "Y/N flag indicating the most recent version of the encounter record."},
            {"name": "patient_email", "type": "STRING", "mode": "NULLABLE",
             "description": "Patient email — PII, do not export to non-curated zones.",
